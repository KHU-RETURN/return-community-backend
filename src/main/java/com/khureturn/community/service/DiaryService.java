    ...
    public List<DiaryResponseDto.DiarySortDto> findDiarySort(List<Diary> diaryList, Principal principal){
        ...
        for(Diary d: diaryList){
            ...
            DiaryResponseDto.DiarySortDto result =DiaryResponseDto.DiarySortDto.builder()
                    ...
                    .member(MemberResponseDto.MemberSortDto.builder().memberId(diarymember.getMemberId()).profileImgURL(diarymember.getProfileImg()).name(diarymember.getName()).nickname(diarymember.getNickname()).build())
